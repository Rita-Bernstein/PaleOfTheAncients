...
public class ShowmanDazed extends AbstractShowmanCard {
    ...
    public ShowmanDazed(TheShowmanBoss owner) {
        super(ID, PaleMod.getCardName(Dazed.class), (String)null, -2, (String)((CardStrings)ReflectionHacks.getPrivateStatic(Dazed.class, "cardStrings")).DESCRIPTION, CardType.STATUS, CardRarity.COMMON, CardTarget.NONE, owner, AbstractMonster.Intent.NONE);
